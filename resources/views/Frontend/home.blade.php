        ...
        <div class="container">
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
                ...
                <div class="lg:col-span-2">
                    ...
                    @if ($heroArticle)
                        <a href="{{ route('article', $heroArticle->slug) }}" class="group block">
                        ...
                        <div class="flex flex-col gap-5 mt-6 pt-6 border-t border-line">
                    ...
                    @foreach ($categories as $category)
                        ...
                        @endphp
                        @if ($latest_cat_art)
                            <div class="py-10 border-t border-line">
                                <div class="flex items-center justify-between mb-6">
                                    <h2 class="eyebrow text-2xl sm:text-3xl font-headline font-bold text-ink flex items-center gap-2">
                                ...
                                <a href="{{ route('article', $latest_cat_art->slug) }}" class="group card-article block bg-paper border border-line rounded-2xl overflow-hidden">
